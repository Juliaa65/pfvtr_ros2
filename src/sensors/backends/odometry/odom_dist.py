...
class OdometryAbsolute(AbsoluteDistanceEstimator):
    ...
    def __init__(self, logger=None):
        ...
        self._log = logger if logger is not None else get_logger("odometry_absolute")
        self._log.info("Odometry absolute distance estimator successfully initialized!")
...
class OdometryRelative(RelativeDistanceEstimator):
    ...
    def __init__(self, logger=None):
        ...
        self._log = logger if logger is not None else get_logger("odometry_relative")
        self._log.info("Odometry relative distance estimator successfully initialized!")
