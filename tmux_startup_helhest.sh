...
tmux send-keys -t pfvtr:teleop "ros2 launch teleop_twist_joy helhest-teleop-launch.py" Enter

tmux send-keys -t pfvtr:pfvtr "source ./install/local_setup.$x" Enter
tmux send-keys -t pfvtr:pfvtr "sleep 2" Enter
tmux send-keys -t pfvtr:pfvtr "ros2 launch pfvtr hellhest-jr.launch.py" Enter
...
tmux send-keys -t pfvtr:repeating 'ros2 action send_goal /pfvtr/repeater pfvtr/action/MapRepeater "{start_pos: 0.0, end_pos: 0.0, null_cmd: true, image_pub: 0, map_name: '"'"''"'"'}"'
